...
const AllClassComponent = ({ category }) => {
  ...
  return (
    <div className="digital-schooling-container flex flex-wrap w-[342px] lg:w-[1152px] lg:justify-center items-center gap-6">
        ...
        >
          ...
          <div className="card-content flex p-6 flex-col items-start gap-12 self-stretch ">
            <div className="all-content flex flex-col items-start gap-6 self-stretch">
              ...
              <div className="payment -mt-3 lg:-mt-0 flex flex-col items-start self-stretch ">
                <p className="text-base font-normal text-neutral-2">
                  Pembayaran Pertama:
                </p>
