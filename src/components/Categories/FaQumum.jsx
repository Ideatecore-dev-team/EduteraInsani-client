            ...
            >
              ...
              {isDropDown[index] && (
                ...
                >
                  {index === "0" && (
                    <p>
                      Edu Tera Insani adalah platform sekolah digital yang
                      dirancang untuk siswa SMP dan SMA, menawarkan jalur
                      pembelajaran yang dipersonalisasi dan akses ke guru-guru
                      ahli dari seluruh dunia. Melalui kurikulum yang
                      komprehensif dan terorganisir, termasuk program inovatif
                      seperti Kurikulum Merdeka Plus, siswa dapat terlibat dalam
                      pembelajaran jarak jauh yang fleksibel.
                    </p>
                  )}
                  {index === "1" && (
                    <p>
