...
const renderCards = () =>
  cardContent.map((card, index) => (
    <div className="facilities-card bg-white flex lg:w-width-6 w-mobile-6 h-height-3.1 p-4 lg:p-6 flex-col items-start gap-4 flex-shrink-0 rounded-2xl">
...
function Facilities() {
  return (
    <div className="facilities-section xs:w-width-sm bg-background flex flex-col xs:justify-center items-start xs:py-12 lg:items-center self-stretch pb-24 gap-gap10">
      <div className="facilities-container xs:w-mobile-6 flex flex-col items-center gap-6 lg:gap-12">
        <h2 className="h2 text-center text-primary text-2xl lg:text-4xl font-semibold">
          Fasilitas Kami
        </h2>
        <div className="facilities-cards flex flex-col lg:flex-row lg:flex-wrap items-start lg:content-start gap-4 lg:gap-6 w-base-content">
          {renderCards()}
        </div>
      </div>
    </div>
