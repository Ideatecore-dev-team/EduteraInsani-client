...
function TeacherCarousel() {
  ...
  const teachers = [
    ...
    },
    {
      ...
      name: "Dr. Tri Yulinda",
      quote:
        "“I believe that learning is not just about understanding the laws of nature but about cultivating a sense of wonder and curiosity. It's about empowering students to question the world around them, think critically, and discover the profound connections that shape our universe.“",
    ...
    },
    {
      ...
      quote:
        "“True education builds strong character, fosters self-confidence, and inspires the courage to explore limitless potential.“",
    ...
    },
    {
      ...
      quote:
        "“Tuhan menciptakan banyak misteri agar kita belajar. Untuk belajar, kita perlu lebih banyak melihat apa yang telah terjadi pada person-person, komunitas-komunitas, etnik-etnik, bangsa-bangsa, atau yang lebih luas adalah peradaban-peradaban dalam kehidupan manusia.“",
...

    {
      ...
      quote:
        "“Learning Aqidah is important. Studying the Koran is equally important, it can water a barren heart and brighten a dim face.“",
    ...
    },
    {
      ...
      quote:
        "“True education empowers individuals to lead vibrant, healthy lives, fostering a foundation for lifelong wellness and resilience.”",
    ...
    },
    {
      ...
      name: "Diah",
      quote:
        "“Berubah memang zona yang tidak nyaman bagi kebanyakan orang. Tapi perubahan adalah keniscayaan, dan kita harus mau beradaptasi cepat dengan kondisi zaman yang mudah berubah pula.“",
    ...
    },
    {
      ...
      name: "Tri Murniasari",
      quote:
        "“Seni mengajarkan kita untuk melihat dunia dengan cara yang baru, merangkul kreativitas, dan berani menciptakan sesuatu yang unik di tengah perubahan yang terus-menerus.“",
    ...
    },
    {
      ...
      name: "Abdul Malik",
      quote:
        "“Be the beacon of goodness if you can't find one. Learning is continuous growth-apply knowledge like the nourishing grains of rice, steadily and consistently“",
      ...
      >
        {teachers.map((teacher, index) => (
          <SwiperSlide key={index}>
            <div className="teacher-card flex flex-col w-mobile-6 justify-between lg:-ml-[13px] lg:w-auto items-center px-6 pb-6 bg-white rounded-2xl relative text-center my-10">
        ...
        <div className="navigation-teacher-carousel ml-2.5 lg:-ml-3 flex justify-between w-width-3.2 absolute top-1/2 transform -translate-y-1/2 bg-red-500 -mt-52 lg:w-full">
